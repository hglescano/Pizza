...
export class IngredientesComponent implements OnInit {
  ...
  constructor(private IngredientesService: IngredientesService, private formBuilder: FormBuilder, 
  ...
  public crearIngredientes() {
    this.IngredientesService.postCreateIngredientes({
  ...
  public eliminarIngredientes(ing_id: any) {
    this.IngredientesService.deleteIngredientes(ing_id).subscribe(
      respuesta => {
  ...
  public infoUpdateIngredientes(ing_id:any, ing_description:any, ing_calories:any) {
  ...
  public actualizarIngredientes(ing_id: any) {
    this.IngredientesService.putUpdateIngredientes({
      ing_id: ing_id,
      ing_description: this.form.value.txting_description,
      ing_calories: this.form.value.txting_calories,
      //ing_estado: this.form.value.txting_estado,
